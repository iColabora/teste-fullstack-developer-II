...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function find() {
      ...
      var skip = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : config.minSkip;

      var _this3 = this;

      var limit = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : config.maxLimit;
      var sort = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : config.sortLastID;
    ...
    key: 'update',
    value: function update(query, document, options) {
      var _this5 = this;
